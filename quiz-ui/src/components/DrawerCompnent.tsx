        ...
        <DrawerBody>
          <Box>
            <Box display="flex" alignItems="center" gap="20px">
              ...
              <Box>
                <Text fontWeight="bold">1 MIN</Text>
                <Text>Keep in mind that its a time bound quiz</Text>
              </Box>
            </Box>
            <Box display="flex" alignItems="center" gap="20px" mt="20px">
              ...
              <Box>
                ...
                <Text>We Believe you will ace it !</Text>
              </Box>
            </Box>
            <Box display="flex" alignItems="center" gap="20px" mt="20px">
              <Text fontSize="40px">
              ...
              <Box>
                ...
                <Text>All the best ! see you on other side</Text>
              </Box>
            </Box>
          </Box>
        </DrawerBody>
